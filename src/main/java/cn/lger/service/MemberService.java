...
public class MemberService {
    ...
    public Page<Member> findMembers(Integer currentPage){
        ...
        Pageable pageable = new PageRequest(currentPage, 3, Sort.Direction.ASC, "memberName");
    ...
    public Page<Member> findMembersByMemberName(Integer currentPage, String memberName){
        ...
        Pageable pageable = PageRequest.of(currentPage, 3, Sort.Direction.ASC, "memberName");
